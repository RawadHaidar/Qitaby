...
import 'package:qitaby_web/pages/admin_books_screen.dart';
...
import 'package:qitaby_web/pages/admin_users_screen.dart';
              ...
              child: isSignedIn
                  ? FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        var userType = snapshot.data!['type'] ?? 'regular';
                          ...
                          children: [
                            ...
                            userType == 'admin'
                                ? _buildMenuItem(context,
                                    title: currentLanguage == 'en'
                                        ? 'Admin Panel (Users)'
                                        : 'Panneau d’administration (Users)',
                                    onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                            ...
                            userType == 'admin'
                                ? _buildMenuItem(context,
                                    title: currentLanguage == 'en'
                                        ? 'Admin Panel (Books)'
                                        : 'Panneau d’administration (Books)',
                                    onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
